...
<%!
    ...
    //modified by dspanos
    //add language drop-down to "name" input types
      ...
      throws java.io.IOException
    {
      ...
      for (int i = 0; i < fieldCount; i++)
      {
         ...
         else sb.append("<span class=\"col-md-5\"><input placeholder=\"");
         sb.append(Utils.addEntities(LocaleSupport.getLocalizedMessage(pageContext, "jsp.submit.edit-metadata.lastname")))
         ...
         if (language)
         	sb.append("\"/></span><span class=\"col-md-4\"><input placeholder=\"");
         else sb.append("\"/></span><span class=\"col-md-5\"><input placeholder=\"");
         sb.append(Utils.addEntities(LocaleSupport.getLocalizedMessage(pageContext, "jsp.submit.edit-metadata.firstname")))
           .append("\" class=\"form-control\" type=\"text\" name=\"")
     ...
     for (int z = 0; z < inputs.length; z++)
     {
       ...
       if (inputType.equals("name"))
       {
           ...
           doPersonalName(out, item, fieldName, dcSchema, dcElement, dcQualifier,
                                          ...
                                          language, inputs[z].getValueLanguageList());
    	   //end dspanos
       }
